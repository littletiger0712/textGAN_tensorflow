...
def run_model(opt, train, val, ixtoword):
    ...
    #     opt.fix_emb = False
    opt.W_emb = (opt.n_words, opt.embed_size)
        ...
        for epoch in range(opt.max_epochs):
            ...
            for _, train_index in kf:
                ...
                if uidx % opt.valid_freq == 0:
                    ...
                    print("Sent:" + u' '.join([ixtoword[x] for x in res['syn_sent'][0] if x != 0]).strip())
